...
if __name__ == "__main__":
    method = input("Enter 'recursive' or 'non-recursive' for Fibonacci calculation: ")
    ...
    if method == "recursive":
        ...
        if n < 0:
            ...
            fibonacci_series = [recursive_fibonacci(i) for i in range(n+1)]
        ...
        if n < 0:
            ...
            fibonacci_series = non_recursive_fibonacci(n)
            print(", ".join(map(str, fibonacci_series)))

    else:
        print("Invalid method. Please enter 'recursive' or 'non-recursive'.")
